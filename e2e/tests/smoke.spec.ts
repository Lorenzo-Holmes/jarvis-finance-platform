...
test.describe('冒烟 · 基础渲染', () => {
  test('官网首页可打开并渲染 iframe', async ({ page, landingPage }) => {
    await landingPage.goto()
    await expect(page.locator('.landing-frame iframe'), '官网 iframe 应渲染').toBeVisible()
  })
  ...
  test('DEV 预览模式可免登录进入工作台外壳', async ({ page, workspacePage }) => {
