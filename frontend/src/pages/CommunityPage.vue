...
.community-tabs { position: sticky; z-index: 30; top: 0; display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); justify-self: start; min-width: 360px; padding: 3px; border: 1px solid var(--line); border-radius: 9px; background: color-mix(in srgb, var(--material-glass, var(--surface)) 92%, transparent); box-shadow: 0 6px 22px rgba(0,0,0,.035); backdrop-filter: blur(14px); overflow: hidden; }
...
.tab-badge { display: inline-grid; place-items: center; min-width: 15px; height: 15px; margin-left: 6px; padding: 0 3px; border-radius: 999px; background: var(--accent); color: var(--bg); font-size: 7px; box-shadow: 0 0 0 3px color-mix(in srgb, var(--accent) 8%, transparent); animation: social-unread-pulse 2.8s ease-in-out infinite; }
.surface-alert { position: fixed; z-index: 80; top: 74px; right: 24px; max-width: min(420px, calc(100vw - 32px)); padding: 10px 13px; border: 1px solid var(--line-strong); border-radius: 10px; background: color-mix(in srgb, var(--material-elevated, var(--surface)) 92%, transparent); box-shadow: var(--material-shadow, 0 16px 40px rgba(0,0,0,.16)); backdrop-filter: blur(18px); font-size: 10px; animation: social-toast-in var(--social-motion-surface) var(--social-ease) both; }
.surface-alert.error { color: var(--bad); border-color: color-mix(in srgb, var(--bad) 24%, var(--line)); }.surface-alert.notice { color: var(--accent-strong); border-color: color-mix(in srgb, var(--accent) 24%, var(--line)); }
...
.group-directory, .user-directory, .conversation-list { min-height: 0; overflow: auto; overscroll-behavior: contain; scrollbar-gutter: stable; scrollbar-width: thin; scrollbar-color: color-mix(in srgb, var(--line-strong) 76%, transparent) transparent; }
.group-directory::-webkit-scrollbar, .user-directory::-webkit-scrollbar, .conversation-list::-webkit-scrollbar, .message-thread::-webkit-scrollbar { width: 8px; height: 8px; }
.group-directory::-webkit-scrollbar-thumb, .user-directory::-webkit-scrollbar-thumb, .conversation-list::-webkit-scrollbar-thumb, .message-thread::-webkit-scrollbar-thumb { border: 2px solid transparent; border-radius: 999px; background: color-mix(in srgb, var(--line-strong) 76%, transparent); background-clip: padding-box; }
...
.group-list > button, .user-directory > button, .conversation-list > button { position: relative; transition: background var(--social-motion-state) ease, color var(--social-motion-state) ease, box-shadow var(--social-motion-state) ease; }
.group-list > button::before, .user-directory > button::before, .conversation-list > button::before { content: ''; position: absolute; left: 0; top: 8px; bottom: 8px; width: 2px; border-radius: 999px; background: var(--accent); opacity: 0; transform: scaleY(.35); transition: opacity var(--social-motion-state) ease, transform var(--social-motion-surface) var(--social-ease); }
.group-list > button:hover, .user-directory > button:hover, .conversation-list > button:hover { background: color-mix(in srgb, var(--workspace-hover-bg) 74%, transparent); }
.group-list > button.active, .user-directory > button.active, .conversation-list > button.active { background: linear-gradient(90deg, color-mix(in srgb, var(--workspace-accent-wash) 88%, transparent), color-mix(in srgb, var(--workspace-accent-wash) 34%, transparent)); box-shadow: inset 0 1px 0 rgba(255,255,255,.018), inset 0 -1px 0 rgba(255,255,255,.018); }
.group-list > button.active::before, .user-directory > button.active::before, .conversation-list > button.active::before { opacity: 1; transform: scaleY(1); }
.group-list > button.active strong, .user-directory > button.active strong, .conversation-list > button.active strong { color: var(--text); }
.group-list > button > span, .user-directory > button > span:nth-child(2), .conversation-list > button > span:nth-child(2) { min-width: 0; flex: 1; display: grid; gap: 3px; }.group-list strong, .user-directory strong, .conversation-list strong { font-size: 9px; }.group-list small, .user-directory small, .conversation-list small { color: var(--subtle); font-size: 8px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.group-list i, .conversation-list i { color: var(--accent-strong); font-size: 8px; font-style: normal; }.conversation-list i { min-width: 18px; height: 18px; display: inline-grid; place-items: center; padding: 0 4px; border-radius: 999px; background: color-mix(in srgb, var(--accent) 14%, transparent); box-shadow: 0 0 0 1px color-mix(in srgb, var(--accent) 20%, transparent); animation: social-unread-pulse 2.8s ease-in-out infinite; }
...
.group-room > header { position: relative; overflow: hidden; background: radial-gradient(circle at 8% 0%, color-mix(in srgb, var(--workspace-accent-wash) 52%, transparent), transparent 46%), linear-gradient(180deg, color-mix(in srgb, var(--surface-2, var(--surface)) 58%, transparent), transparent); box-shadow: inset 0 1px 0 rgba(255,255,255,.025); }
.group-room > header::after { content: ''; position: absolute; right: 18px; bottom: 0; width: 96px; height: 1px; background: linear-gradient(90deg, transparent, color-mix(in srgb, var(--accent) 38%, transparent)); pointer-events: none; }
.group-edit-fields { flex: 1; display: grid; gap: 7px; }
.group-actions .danger-action { color: var(--bad); }
.group-metrics { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; padding: 0 12px; }.group-metrics div { padding: 11px 12px; border: 1px solid var(--line); border-radius: 8px; display: grid; gap: 5px; background: color-mix(in srgb, var(--panel) 72%, transparent); transition: transform var(--social-motion-surface) var(--social-ease), border-color var(--social-motion-state) ease, background var(--social-motion-state) ease; }.group-metrics div:hover { transform: translateY(-1px); border-color: color-mix(in srgb, var(--accent) 20%, var(--line-strong)); background: color-mix(in srgb, var(--panel) 82%, var(--workspace-accent-wash)); }.group-metrics span { color: var(--subtle); font-size: 8px; }.group-metrics b { color: var(--text); font-size: 15px; letter-spacing: -.02em; }.group-metrics div:last-child b { color: var(--accent-strong); font-size: 11px; letter-spacing: 0; }
...
.invite-panel { position: relative; z-index: 12; display: grid; gap: 6px; }.invite-candidates { position: absolute; z-index: 20; top: calc(100% + 5px); left: 12px; right: 12px; max-height: 240px; display: grid; border: 1px solid var(--line-strong); border-radius: 10px; overflow: auto; background: color-mix(in srgb, var(--material-elevated, var(--panel)) 94%, transparent); box-shadow: var(--material-shadow-elevated, 0 22px 64px rgba(0,0,0,.22)); backdrop-filter: blur(18px); animation: social-popover-in var(--social-motion-surface) var(--social-ease) both; }.invite-candidates > button { display: flex; align-items: center; gap: 8px; padding: 9px 10px; border: 0; border-bottom: 1px solid var(--line); background: transparent; color: inherit; cursor: pointer; text-align: left; }.invite-candidates > button:hover, .invite-candidates > button:focus-visible { background: var(--workspace-accent-wash); }.invite-candidates > button:last-child { border-bottom: 0; }.invite-candidates > button > span:nth-child(2) { min-width: 0; flex: 1; display: grid; gap: 3px; }.invite-candidates strong { font-size: 9px; }.invite-candidates small { color: var(--subtle); font-size: 8px; }.invite-candidates i { color: var(--accent-strong); font-size: 8px; font-style: normal; }
...
.profile-preview > header { position: relative; overflow: hidden; background: radial-gradient(circle at 8% 12%, color-mix(in srgb, var(--workspace-accent-wash) 62%, transparent), transparent 44%), linear-gradient(180deg, color-mix(in srgb, var(--surface-2, var(--surface)) 48%, transparent), transparent); box-shadow: inset 0 1px 0 rgba(255,255,255,.026); animation: social-card-in var(--social-motion-surface) var(--social-ease) both; }
.profile-preview .avatar.large { box-shadow: 0 0 0 4px color-mix(in srgb, var(--workspace-accent-wash) 52%, transparent), 0 8px 22px rgba(0,0,0,.08); transition: transform var(--social-motion-surface) var(--social-ease), box-shadow var(--social-motion-surface) ease; }.profile-preview > header:hover .avatar.large { transform: scale(1.025); box-shadow: 0 0 0 5px color-mix(in srgb, var(--workspace-accent-wash) 62%, transparent), 0 10px 28px rgba(0,0,0,.11); }
.contact-card { border-left: 2px solid color-mix(in srgb, var(--accent) 58%, var(--line)); background: color-mix(in srgb, var(--workspace-accent-wash) 24%, transparent); transition: border-color var(--social-motion-state) ease, background var(--social-motion-state) ease; }.contact-card:hover { border-left-color: var(--accent); background: color-mix(in srgb, var(--workspace-accent-wash) 38%, transparent); }
.achievement-strip { display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 8px; padding: 0 14px; }.achievement-strip article { padding: 11px; border: 1px solid var(--line); border-radius: 9px; display: grid; gap: 5px; background: color-mix(in srgb, var(--panel) 72%, transparent); transition: transform var(--social-motion-surface) var(--social-ease), border-color var(--social-motion-state) ease, background var(--social-motion-state) ease; }.achievement-strip article:hover { transform: translateY(-1px); border-color: color-mix(in srgb, var(--accent) 20%, var(--line-strong)); background: color-mix(in srgb, var(--panel) 82%, var(--workspace-accent-wash)); }.achievement-strip span, .achievement-strip small { color: var(--subtle); font-size: 7px; }.achievement-strip b { font-size: 9px; }
.activity-list { position: relative; display: grid; gap: 0; padding: 0 14px 14px 30px; }.activity-list::before { content: ''; position: absolute; left: 18px; top: 30px; bottom: 16px; width: 1px; background: linear-gradient(180deg, color-mix(in srgb, var(--accent) 20%, var(--line)), var(--line), transparent); }.activity-list article { position: relative; display: grid; grid-template-columns: 120px 1fr auto; gap: 8px; padding: 9px 0; border-bottom: 1px solid var(--line); }.activity-list article::before { content: ''; position: absolute; left: -15px; top: 14px; width: 6px; height: 6px; border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--line-strong)); border-radius: 50%; background: var(--surface); box-shadow: 0 0 0 3px var(--surface); transition: transform var(--social-motion-surface) var(--social-ease), border-color var(--social-motion-state) ease, background var(--social-motion-state) ease; }.activity-list article:hover::before { transform: scale(1.12); border-color: var(--accent); background: color-mix(in srgb, var(--accent) 30%, var(--surface)); }.activity-list article span, .activity-list article small { color: var(--subtle); font-size: 8px; }.activity-list article p { margin: 0; color: var(--muted); font-size: 9px; transition: color var(--social-motion-state) ease; }.activity-list article:hover p { color: var(--text); }
.message-room { grid-template-rows: auto minmax(280px, 1fr) auto; overflow: hidden; }.message-room > header { position: relative; overflow: hidden; background: radial-gradient(circle at 12% 0%, color-mix(in srgb, var(--workspace-accent-wash) 48%, transparent), transparent 48%); }.message-room > header::after { content: ''; position: absolute; left: 16px; bottom: 0; width: 72px; height: 1px; background: linear-gradient(90deg, var(--accent), transparent); opacity: .42; }.message-thread { padding: 16px; overflow: auto; display: flex; flex-direction: column; gap: 9px; background: linear-gradient(180deg, color-mix(in srgb, var(--surface-2, var(--surface)) 34%, transparent), transparent 32%); scroll-behavior: smooth; }.message-thread article { position: relative; max-width: 72%; align-self: flex-start; padding: 9px 11px; border: 1px solid var(--line); border-radius: 11px 11px 11px 4px; background: color-mix(in srgb, var(--panel) 88%, transparent); box-shadow: 0 4px 14px rgba(0,0,0,.035); transition: transform var(--social-motion-surface) var(--social-ease), border-color var(--social-motion-state) ease, box-shadow var(--social-motion-surface) ease, background var(--social-motion-state) ease; }.message-thread article:hover, .message-thread article:focus-within { transform: translateY(-1px); border-color: color-mix(in srgb, var(--line-strong) 74%, var(--accent)); box-shadow: 0 8px 22px rgba(0,0,0,.06); }.message-thread article.mine { align-self: flex-end; border-radius: 11px 11px 4px 11px; border-color: color-mix(in srgb, var(--accent) 16%, var(--line)); background: color-mix(in srgb, var(--workspace-accent-wash) 70%, var(--panel)); }.message-thread article.mine::after { content: ''; position: absolute; top: 8px; bottom: 8px; right: -1px; width: 2px; border-radius: 999px; background: color-mix(in srgb, var(--accent) 52%, transparent); }.message-thread p { margin: 0 0 5px; font-size: 10px; line-height: 1.58; }.message-thread small { color: var(--subtle); font-size: 7px; }.message-room > footer { display: flex; gap: 8px; padding: 12px; border-top: 1px solid var(--line); background: color-mix(in srgb, var(--surface) 94%, transparent); }.message-compose { min-width: 0; flex: 1; display: grid; gap: 4px; }.message-compose small { color: var(--subtle); font-size: 7px; text-align: right; }
...
.message-thread { overscroll-behavior: contain; scrollbar-gutter: stable; scrollbar-width: thin; scrollbar-color: color-mix(in srgb, var(--line-strong) 76%, transparent) transparent; }
...
@keyframes social-popover-in { from { opacity: 0; transform: translateY(-5px) scale(.985); } to { opacity: 1; transform: translateY(0) scale(1); } }
@keyframes social-unread-pulse { 0%, 100% { box-shadow: 0 0 0 1px color-mix(in srgb, var(--accent) 18%, transparent), 0 0 0 0 transparent; } 50% { box-shadow: 0 0 0 1px color-mix(in srgb, var(--accent) 28%, transparent), 0 0 0 4px color-mix(in srgb, var(--accent) 6%, transparent); } }
...
@media (max-width: 700px) {
  .surface-alert { top: 64px; left: 12px; right: 12px; max-width: none; }
  ...
  .community-tabs { scroll-snap-type: x proximity; }
  .community-tabs button { scroll-snap-align: start; }
