...
.profile-grid { display: grid; grid-template-columns: minmax(0, 1fr) 230px; gap: 14px; }.profile-grid > main { display: grid; gap: 12px; align-content: start; }.profile-grid > aside { position: sticky; top: 12px; display: grid; gap: 9px; align-content: start; align-self: start; }
...
.achievement-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 8px; margin-top: 12px; }.achievement-grid article { position: relative; overflow: hidden; min-height: 135px; display: grid; align-content: start; gap: 7px; padding: 12px; border: 1px solid var(--line); border-radius: 9px; opacity: .54; background: color-mix(in srgb, var(--panel) 70%, transparent); transition: transform var(--social-motion-surface) var(--social-ease), opacity var(--social-motion-state) ease, border-color var(--social-motion-state) ease, background var(--social-motion-state) ease, box-shadow var(--social-motion-surface) ease; }.achievement-grid article::before { content: ''; position: absolute; left: 0; top: 12px; bottom: 12px; width: 2px; border-radius: 999px; background: var(--accent); opacity: 0; transform: scaleY(.4); transition: opacity var(--social-motion-state) ease, transform var(--social-motion-surface) var(--social-ease); }.achievement-grid article:hover { opacity: .78; transform: translateY(-1px); border-color: color-mix(in srgb, var(--line-strong) 74%, var(--accent)); box-shadow: 0 10px 26px rgba(0,0,0,.055); }.achievement-grid article.unlocked { opacity: 1; border-color: color-mix(in srgb, var(--accent) 28%, var(--line)); background: linear-gradient(135deg, color-mix(in srgb, var(--workspace-accent-wash) 38%, transparent), color-mix(in srgb, var(--panel) 76%, transparent)); }.achievement-grid article.unlocked::before { opacity: .9; transform: scaleY(1); }.badge-mark { display: flex; align-items: center; justify-content: space-between; color: var(--subtle); font: 650 7px/1 ui-monospace, monospace; }.badge-mark b { color: var(--accent-strong); font-size: 12px; transition: transform var(--social-motion-surface) var(--social-ease); }.achievement-grid article.unlocked:hover .badge-mark b { transform: scale(1.08); }.achievement-grid h4 { margin: 0; font-size: 10px; }.achievement-grid p { margin: 0; color: var(--muted); font-size: 8px; line-height: 1.5; }.achievement-grid time { color: var(--subtle); font-size: 7px; }.progress { display: grid; grid-template-columns: 1fr auto; align-items: center; gap: 7px; }.progress small { color: var(--subtle); font-size: 7px; font-variant-numeric: tabular-nums; }
.activity-list { position: relative; display: grid; margin-top: 8px; padding-left: 18px; }.activity-list::before { content: ''; position: absolute; left: 4px; top: 8px; bottom: 8px; width: 1px; background: linear-gradient(180deg, color-mix(in srgb, var(--accent) 22%, var(--line)), var(--line), transparent); }.activity-list article { position: relative; display: grid; grid-template-columns: 140px 1fr auto; gap: 9px; padding: 10px 0; border-bottom: 1px solid var(--line); transition: color var(--social-motion-state) ease, background var(--social-motion-state) ease; }.activity-list article::before { content: ''; position: absolute; left: -18px; top: 15px; width: 7px; height: 7px; border: 1px solid color-mix(in srgb, var(--accent) 32%, var(--line-strong)); border-radius: 50%; background: var(--surface); box-shadow: 0 0 0 3px var(--surface); transition: background var(--social-motion-state) ease, border-color var(--social-motion-state) ease, transform var(--social-motion-surface) var(--social-ease); }.activity-list article:hover::before { transform: scale(1.12); border-color: var(--accent); background: color-mix(in srgb, var(--accent) 34%, var(--surface)); }.activity-list span, .activity-list time { color: var(--subtle); font-size: 8px; }.activity-list p { margin: 0; color: var(--muted); font-size: 9px; transition: color var(--social-motion-state) ease; }.activity-list article:hover p { color: var(--text); }
...
@media (max-width: 980px) { .profile-grid { grid-template-columns: 1fr; }.profile-grid > aside { position: static; grid-template-columns: repeat(3, 1fr); }.privacy-summary { grid-column: 1 / -1; } }
@media (max-width: 700px) { .surface-alert { top: 64px; left: 12px; right: 12px; max-width: none; }.page-head { align-items: flex-start; flex-direction: column; }.page-head > button { min-height: 40px; }.identity-card { grid-template-columns: auto 1fr; }.completion { grid-column: 1 / -1; }.form-grid, .privacy-grid, .profile-grid > aside { grid-template-columns: 1fr; }.activity-list article { grid-template-columns: 1fr; }.achievement-filters, .activity-filters { flex-wrap: nowrap; overflow-x: auto; padding-bottom: 3px; scrollbar-width: none; scroll-snap-type: x proximity; }.achievement-filters::-webkit-scrollbar, .activity-filters::-webkit-scrollbar { display: none; }.achievement-filters button, .activity-filters button { flex: 0 0 auto; min-height: 34px; scroll-snap-align: start; } }
